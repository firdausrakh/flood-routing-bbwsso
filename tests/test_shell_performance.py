...
class ShellPerformanceTests(unittest.TestCase):
    ...
    def test_html_revalidates_and_loads_routing_only_scripts(self):
        ...
        self.assertIn('/static/js/spatial.js?v=2.2.5-dta-river', html)
        self.assertIn('/static/js/flood-routing.js?v=2.2.5-first-point', html)
    ...
    def test_frontend_uses_docked_layout_and_keeps_model_internals_hidden(self):
        ...
        self.assertIn('riverAssetCache = new Map()', spatial)
        self.assertIn("return `/api/hec-routing/modeled-rivers?${qs.toString()}`", spatial)
        ...
        self.assertNotIn("qs.set('scenario', modeledRiverScenario)", spatial)
